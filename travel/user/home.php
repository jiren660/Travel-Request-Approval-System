...
<head>
  ...
  <title>Home - Travel Request Approval System</title>
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <a href="../user/requests.php" class="icon">
  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <div class="buttons">
        <a href="requests.php" style="color:white;"><button>View Travel Requests</button></a>
        <a href="addrequest.php" style="color:white;"><button>Create New Travel Request</button></a>
      </div>
    </div>
  </div>
