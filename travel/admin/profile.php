...
if ($user_id) {
  $stmt = $conn->prepare("SELECT first_name, middle_name, last_name, email, username FROM users WHERE id = :id");
...
<div class="profile-container">
  ...
  <div class="profile-actions">
    ...
    <a href="change_password.php" class="btn btn-pass">Change Password</a>
  </div>
</div>
